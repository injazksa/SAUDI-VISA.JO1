...
def restore_settings():
    print("Restoring site settings and contact info...")
    config = {
...
def restore_faqs():
    ...
    for f in faqs:
        try:
            # Using try-except for each to avoid stopping on RLS errors
            supabase.table('faqs').insert(f).execute()
        except Exception as e:
            print(f"Error restoring FAQ: {e}")
    print("FAQs restoration attempt finished.")

def restore_testimonials():
    print("Restoring testimonials (Customer Reviews)...")
    testimonials = [
    ...
    print("Testimonials restoration attempt finished.")
...
def restore_nationalities():
    print("Restoring nationalities...")
    nats = [
    ...
    for n in nats:
        try:
            supabase.table('nationalities').insert(n).execute()
        except Exception as e:
            print(f"Error adding nationality {n['name_ar']}: {e}")
    print("Nationalities restoration attempt finished.")
...
if __name__ == "__main__":
    ...
    restore_services()
    restore_nationalities()
    print("Full data restoration process completed.")
